...
const navigation = {
  ...
  gameplay: [
    { name: "Meta Decks", href: "/gameplay?tab=meta" },
    { name: "Tournaments", href: "/gameplay?tab=tournaments" },
    { name: "Deck Builder", href: "/decks/builder" },
  ],
  marketplace: [
    { name: "Buy Cards", href: "/marketplace?tab=buy" },
    { name: "Sell Cards", href: "/marketplace?tab=sell" },
    { name: "Orders", href: "/marketplace?tab=orders" },
    { name: "Wantslists", href: "/marketplace?tab=wants" },
    { name: "Cart", href: "/marketplace?tab=cart" },
  ],
  company: [
    { name: "About", href: "/" },
    { name: "Blog", href: "/" },
